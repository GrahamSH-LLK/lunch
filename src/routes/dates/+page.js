export const load = async () => {
	...
	const countsFromDays = (daysInput) => {
		...
		const countPerDayReduced = Object.entries(countPerDay).reduce((acc, [key, value]) => {
			let day = key % 4;
			if (day === 0) {
				day = 4;
			}
