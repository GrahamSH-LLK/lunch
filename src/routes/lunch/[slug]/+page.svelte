...
{#if today[0].items.length}
	<MetaTags
		openGraph={{
			...
			title: today[0]?.items[0].englishAlternateName || '',
						...
						{#each category.items as meal}
							{#key meal.englishAlternateName}
								...
								rgba(0, 0, 0, 0.6)
									...
									in:slide={{ duration: 200, delay: 80, axis: 'x', easing: quintIn }}
									out:slide={{ duration: 200, axis: 'x', easing: quintOut }}
								>
									<div class="w-full flex justify-between items-center m-2">
										<span class="text-white mr-1 min-w-40">{meal.englishAlternateName}</span>
										<Sheet.Root>
											<Sheet.Trigger><Button variant="secondary">See More</Button></Sheet.Trigger>

											<Sheet.Content>
												<Sheet.Header>
													<Sheet.Title>{meal.englishAlternateName}</Sheet.Title>
													<Sheet.Description>
                                    ...
                                    <div class="overflow-y-auto max-h-full">
												...
												<table class="w-64 p-4 border-2 border-primary border-spacing-4">
													...
													<tbody>
														...
														<tr
															...
															<p class="text-3xl font-extrabold px-1">
												...
												{#if meal['ingredientStatement']}
                                    <p class="font-bold">Ingredients</p>
													<p>
														{meal['ingredientStatement']}
													</p>
												{/if}
                                 </div>
											</Sheet.Content>
